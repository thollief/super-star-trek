...
"                SSSSS   U   U   PPPPP   EEEEE   RRRRR
               ...
               Curses Support and Gameplay Updates By
                            Stas Sergeev

         Refactoring, BSD features, and Historical Research By
                           Eric S. Raymond

                Lisp Port (this implementation) By
                          Tim Holliefield

              See Acknowledgements and other help topics
                 for names of additional contributors")
...
lose points for bad things.
 ...
 You gain--
     ...
     (6)    1 point for each Romulan ship surrendered.
...
\"Plaque\" is adjusted for A4 paper :-)
...
Status report now indicates when dilithium crystals are on board.

Per Dave Matuszek's remarks, Thingy state is never saved across games.

Added game option selection so you can play a close (but not bug-for-
bug identical) approximation of older versions.

Half the quadrants now have inhabited planets, from which one
...
User input is now logged so we can do regression testing.

More BSD-Trek features: You can now lose if your entire crew
...
Still more BSD-Trek: we now have a weighted damage table.
...
rely on C pointers, in particular the keyboard input routines, had to be
rewritten. Additional revisions take advantage of Lisp data structures
